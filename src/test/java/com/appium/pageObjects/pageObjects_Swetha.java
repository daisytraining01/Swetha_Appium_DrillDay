...
public class pageObjects_Swetha  {
 ...
 public static final	By AddtoReceipes= By.id("com.buzzfeed.tasty:id/menu_favorite");
 public static final	By MyReceipes = By.id("com.buzzfeed.tasty:id/action_my_recipes");
 public static final    By Discover = By.xpath("//android.widget.FrameLayout[@content-desc=\"Discover\"]/android.widget.ImageView");
